        ...
        <div className="w-full mx-auto">
            <div className="text-center mb-10 space-y-3">
                <div className="flex justify-center mb-6">
                    <div className="p-3 bg-gradient-to-br from-primary/20 to-transparent rounded-2xl ring-1 ring-white/10 shadow-lg">
                ...
                <p className="text-[#CCCCCC] text-lg font-light transition-all duration-300 max-w-[90%] mx-auto">
                    {step === "RATING" && "Califica tu experiencia hoy"}
